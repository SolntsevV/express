export default function appSrc(express, bodyParser, createReadStream, crypto, http, mongo) {
  ...
  app.post('/insert/', async (req, res) => {
    ...
    const connection = await connect('mongodb+srv://admin:2p6mc34h@cluster0.qi9tc.mongodb.net/mongodemo?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true});
